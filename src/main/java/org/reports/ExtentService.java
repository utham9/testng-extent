...
public class ExtentService implements Serializable {
  ...
  private static class ExtentReportsLoader {
    ...
    private static final String[] DEFAULT_SETUP_PATH =
        new String[] {"extent.properties", "com/aventstack/adapter/extent.properties"};
    ...
    private static void createViaProperties() {
      ...
      Optional<InputStream> is =
          Arrays.stream(DEFAULT_SETUP_PATH)
    ...
    private static void createViaSystem() {
      if ("true".equals(System.getProperty(INIT_SPARK_KEY))) initSpark(null);
    }
    ...
    private static String getOutputPath(Properties properties, String key) {
      ...
      else out = System.getProperty(key);
      out =
          out == null || out.equals("null") || out.isEmpty()
              ? OUTPUT_PATH + key.split("\\.")[2] + "/"
              : out;
      return out;
    }
    ...
    private static void attach(ReporterConfigurable r, Properties properties, String configKey) {
      Object configPath =
          properties == null ? System.getProperty(configKey) : properties.get(configKey);
